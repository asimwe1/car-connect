...
const VerifyOTP = () => {
  ...
  const handleResendOTP = async () => {
    ...
    try {
      // For resend, we would need a separate endpoint in the backend
      // For now, we'll show a message that resend is not implemented
      notify.success('OTP Sent', 'A new verification code has been sent to your phone');
    } catch (error: any) {
