                        ...
                        <>
                            ...
                            <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-gray-50">
                                {(isSystemChatMode ? systemChatMessages : messages).map((message) => (
                                    <div
                                        key={message._id}
                                        className={`flex items-end gap-2 ${message.sender._id === user?.id ? 'justify-end' : 'justify-start'
                                            }`}
                                    >
                                        ...
                                        {/* Message bubble */}
                                        <div
                                            className={`max-w-[85%] sm:max-w-[70%] rounded-2xl px-4 py-3 shadow-sm ${message.sender._id === user?.id
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-end gap-1 mt-1">
                                                <span
                                                    className={`text-xs ${message.sender._id === user?.id
                                                            ? 'text-white/70'
                                                            : 'text-gray-500'
                                                        }`}
                                                >
